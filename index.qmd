...
This is "citatel", home of what started as the "tactile" TTRPG system. You can learn more about the game [here](book/about/about.qmd). The [GitHub repo](https://github.com/ikolith/citatel) includes the code for the site itself, as well as all of the tooling and data used to generate enemies, weapons, etc. You can learn more about the role of the code [here](book/resources/why_code.md).

The site is set up so you can read through the whole thing starting at [About](book/about/about.qmd) like a book. Eventually this should all be a physical honest-to-god-book in addition to being a website.
