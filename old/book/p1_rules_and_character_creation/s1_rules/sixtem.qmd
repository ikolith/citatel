...
## How Characters Work
A basic character consists of a list of attribute scores, a defense score, movement speed, and a pair of HEALTH numbers. The particular values for HP, defense, etc. will vary. Here is an example:

**HEALTH 3:9, DEFENSE 6, MOVEMENT SPEED 4**
...
The names of attributes are typically shortened to the first three or four letters. A given character might also have skills, an inventory, conditions, or any number of other things. 
