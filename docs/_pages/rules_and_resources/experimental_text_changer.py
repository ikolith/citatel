...
.replace("▷▷▶", "$\\triangleright\\mkern-7mu\\triangleright\\mkern-7mu\\blacktriangleright$")
.replace("▶▷▷", "$\\blacktriangleright\\mkern-7mu\\triangleright\\mkern-7mu\\triangleright$")
.replace("ツ", "'v'")
...
\\let\\endhead\\relax %% ??""") #I think this has to be after the longtable include?
.replace("longtable", "supertabular") # I think this breaks it
.replace(r"""  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4545}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2727}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2727}}@{}}""", "ll@{}}")
)
