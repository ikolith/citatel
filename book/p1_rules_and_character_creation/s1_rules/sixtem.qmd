...
A basic character consists of a list of attribute scores, a defense score, movement speed, and max HP (Health Points).  The particular values for HP, defense, etc. will vary. Here is an example:
