...
\[Bashing]: Not sure what sort of blunt weapon would blunt in a way that is different enough to justify it, but it is there.  

Damage types that will remain unused:

\[Poking]: Too silly.
\[Bonking]: Boooo!  
\[Pickling]: What a warpickle does.  
\[Striking]: Confusing! See: \[Stabbing].
