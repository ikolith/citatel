...
If a character passes their check of wins their contest, their success might be accompanied by secondary effects according to the dice that they rolled. Here are a list of the condition names and their triggers.
...
A Crit also counts as "Matching". An example of one of these effects is a character who, when dealing a certain damage type, inflicts the \[bleed] condition on half crit. 

There is one condition that can be activated when a character fails, the Crit Fail.
