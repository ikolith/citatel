...
<!-- CON used to let you ignore some portion of a number of accumulating status effects (like poison and bleed)...
Eh, I'm gonna just make that a skill.-->
Every point of CON gives you 1 extra crit health and 2 extra standard health.
<!-- not clear thats the right number but hey! -->
...
If you don't have a [special] score you fail any check, contest, roll, whatever related to that score. The [sp] tag is just a shorter version of the [special] tag.

#### "Standard" Scores

Just a convention for non-[sp] scores that are important for the current setting. Make a decision about these scores when creating something for this setting. This is a convention, not a strict rule.
...
Double 6s are good. You did as good as you could have. If this is an attack roll, do 1 crit damage. 
...
By "default" every character has 3 identical cards. The cards say "1 AP" and indicate what character they belong to.  
