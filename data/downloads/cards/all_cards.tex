...
\smallskip  \hrule \smallskip \textit{A bent creature, shriveled and distended. Rattling sandpaper breathing and muttering. Eyes shriveled and wasted, or a dull black.} 
...
\card{89mm}{64mm}{\textbf{\large{Dogman}} 
 
\emph{HP:} 2d6 
 
\emph{Scores:} 1 STR, 1 AGI, 7 Defense 
 
\emph{Holds:} Dogman Weapons 
 
}%
\card{89mm}{64mm}{\textbf{\large{Dogman Weapons}} 
...
\card{89mm}{64mm}{\textbf{\large{Dueling Sabre}} 
 
\emph{Tags:} one-handed, hilted, bladed 
 
\emph{Speed:} (1n1)$\Rightarrow$(1n2) 
 
\emph{To-Hit:} +AGI or +DEX 
 
\smallskip  \hrule \smallskip \emph{Attacks: }
\begin{itemize}
    \item 1d8 (S) $\blacktriangleright\mkern-7mu\triangleright\mkern-7mu\triangleright$
- 1d6 (P) $\blacktriangle$
...
\newline%
\card{89mm}{64mm}{\textbf{\large{Black Shotel}} 
...
\smallskip  \hrule \smallskip \emph{Attacks: }
\begin{itemize}
    \item 1d4+DEX (P) $\triangleright\mkern-7mu\triangleright\mkern-7mu\blacktriangleright$
...
\emph{Tags:} hilted, two-handed, bladed, reach: 2 
...
\newline%
\card{89mm}{64mm}{\textbf{\large{Two Handed Spear}} 
 
\emph{Tags:} shafted, two-handed, reach: 3 
...
\card{89mm}{64mm}{\textbf{\large{Isopod Name}} 
